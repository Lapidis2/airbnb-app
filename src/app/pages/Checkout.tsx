            ...
            <div className="bg-white rounded-2xl border border-[#EBEBEB] p-6">
              ...
              {paymentMethod === 'bank' && (
                <div className="p-5 bg-[#F7F7F7] rounded-xl space-y-3 text-sm">
                  <div className="flex justify-between"><span className="text-[#717171]">Bank Name</span><span className="text-[#222222] font-semibold">StayBnb Bank</span></div>
                  <div className="flex justify-between"><span className="text-[#717171]">Account Name</span><span className="text-[#222222] font-semibold">StayBnb Ltd.</span></div>
