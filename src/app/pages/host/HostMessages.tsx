...
const conversations = [
  {
    ...
    guest: 'John Smith',
    avatar: 'JS',
    property: 'Modern Apartment in Kigali',
  ...
  },
  {
    ...
    guest: 'Emma Watson',
    avatar: 'EW',
    property: 'Garden Cottage Kigali',
  ...
  },
  {
    ...
    guest: 'Priya Patel',
    avatar: 'PP',
    property: 'Executive Suite Downtown',
  ...
  },
  {
    ...
    messages: [
      ...
      { id: 2, from: 'host', text: "Of course! WiFi: StayBnb_Kigali | Password: Welcome2026! Let me know if it works.", time: '10:35 AM', date: '2 days ago' },
...
const quickReplies = [
  ...
  "WiFi Name: StayBnb_Kigali | Password: Welcome2026!",
