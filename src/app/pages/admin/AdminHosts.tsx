...
const hosts = [
  { id: '1', name: 'Sarah Johnson',  email: 'sarah.j@email.com',  avatar: 'SJ', location: 'Kigali, Rwanda',          listings: 3, bookings: 24, revenue: 4820,  rating: 4.9,  reviews: 127, status: 'superhost' as HostStatus, joined: 'Jan 2024', verified: true,  responseRate: '99%', responseTime: 'Within 1 hour' },
  { id: '2', name: 'Michael Chen',   email: 'm.chen@email.com',   avatar: 'MC', location: 'Nairobi, Kenya',           listings: 2, bookings: 18, revenue: 6240,  rating: 5.0,  reviews: 89,  status: 'superhost' as HostStatus, joined: 'Feb 2024', verified: true,  responseRate: '97%', responseTime: 'Within 2 hours' },
  { id: '3', name: 'Marie Dubois',   email: 'marie.d@email.com',  avatar: 'MD', location: 'Paris, France',            listings: 1, bookings: 31, revenue: 3720,  rating: 4.8,  reviews: 203, status: 'active'    as HostStatus, joined: 'Nov 2023', verified: true,  responseRate: '95%', responseTime: 'Within 3 hours' },
  { id: '4', name: 'David Williams', email: 'd.williams@email.com',avatar: 'DW', location: 'New York, USA',            listings: 4, bookings: 42, revenue: 14700, rating: 4.95, reviews: 156, status: 'superhost' as HostStatus, joined: 'Sep 2023', verified: true,  responseRate: '98%', responseTime: 'Within 1 hour' },
  { id: '5', name: 'Grace Mwangi',   email: 'grace.m@email.com',  avatar: 'GM', location: 'Mombasa, Kenya',           listings: 2, bookings: 15, revenue: 2700,  rating: 4.85, reviews: 94,  status: 'active'    as HostStatus, joined: 'Mar 2024', verified: true,  responseRate: '92%', responseTime: 'Within 6 hours' },
  { id: '6', name: 'Priya Patel',    email: 'p.patel@email.com',  avatar: 'PP', location: 'Mumbai, India',            listings: 1, bookings: 22, revenue: 5400,  rating: 4.7,  reviews: 78,  status: 'pending'   as HostStatus, joined: 'Feb 2024', verified: false, responseRate: '88%', responseTime: 'Within 12 hours' },
