            ...
            <div className="bg-white rounded-2xl border border-[#EBEBEB] p-8">
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <input type="email" defaultValue="jeanpierre.h@staybnb.com" className="w-full px-4 py-3.5 rounded-xl border border-[#DDDDDD] text-[#222222] text-sm outline-none focus:border-[#FF385C] transition-colors" />
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label className="block text-[#222222] text-sm font-semibold mb-2">Phone</label>
                    <input type="tel" defaultValue="+1 (888) 000-0000" className="w-full px-4 py-3.5 rounded-xl border border-[#DDDDDD] text-[#222222] text-sm outline-none focus:border-[#FF385C] transition-colors" />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea defaultValue="Platform administrator responsible for managing users, listings, and ensuring quality standards across StayBnb." className="w-full px-4 py-3 rounded-xl border border-[#DDDDDD] text-[#222222] text-sm outline-none focus:border-[#FF385C] transition-colors resize-none h-24" />
                </div>
