...
import { Search, MapPin, ChevronLeft, ChevronRight, Minus, Plus, X } from 'lucide-react';
...
export function HeroSearch() {
  ...
  return (
    <div ref={wrapRef} className="relative" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="hidden md:grid md:grid-cols-[1fr_1.3fr_1fr_auto] bg-white rounded-2xl border-2 border-[#DDDDDD] shadow-lg overflow-hidden">
        {/* WHERE */}
        <div
          className="flex flex-col justify-center px-5 py-3.5 cursor-pointer transition-colors border-r-2 border-[#DDDDDD] rounded-l-2xl"
        ...
        >
          ...
          <input
            ...
            style={{ color: location ? '#1C1C1E' : '#9E9E9E' }}
          />
        </div>

        {/* WHEN */}
        <div
          className="flex flex-col justify-center px-5 py-3.5 cursor-pointer transition-colors border-r-2 border-[#DDDDDD]"
        ...
        {/* WHO */}
        <div
          className="flex flex-col justify-center px-5 py-3.5 cursor-pointer transition-colors"
        ...
        <div className="flex items-center px-2 py-2">
          <button
            ...
            className="flex items-center gap-2 bg-[#FF5A5F] hover:bg-[#E31C5F] text-white px-6 py-3 rounded-xl font-bold text-sm transition-colors shadow-md whitespace-nowrap"
